...
def getLongValueWithOffset():
    rawBytes = hx.getRawBytes()
    longValueWithOffset = hx.rawBytesToLong(rawBytes)
    return longValueWithOffset

def setReferenceUnit(knownWeight=0.0, longValueWithOffset=0):
    referenceUnit = longValueWithOffset / knownWeight
